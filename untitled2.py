...
rect_id = None
path = "C:/Users/diego/Desktop/Filtros/gato.jpg"
rect_list = list()
rect_main_data = list()
ImageFilePath = ""
ImgOpen = None
...
rawImage = Image.open("C:/Users/diego/Desktop/Filtros/gato.jpg")
...
def GetImageFilePath():
    ...
    ImgOpen = Image.open("C:/Users/diego/Desktop/Filtros/gato.jpg")

    if len(ImageFilePath) > 0:  
        test = True                          
        img = ImageTk.PhotoImage(Image.open("C:/Users/diego/Desktop/Filtros/gato.jpg"))        
        ImageFound = True        
...
def cropImages():
    im = Image.open("C:/Users/diego/Desktop/Filtros/gato.jpg")    
